...
[PR #3](https://github.com/susumutomita/ZeroKeyMate/pull/3) preserves the initial source-delivery history while retaining the working September 13 runtime. [The reconciliation record](source-import-reconciliation.md) lists every original import path and its release disposition. Old alternate implementations remain in their original commit; they are not silently substituted for the demonstrated checkout.
