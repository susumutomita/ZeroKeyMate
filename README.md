...
| Weather conversation | [Build 19](docs/weather-conversation.md): current forecasts from Open-Meteo, city clarification, dated answers and source links; unavailable data is never replaced with an invented forecast. General web search is not implemented. |
