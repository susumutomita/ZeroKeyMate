...
assert manifest.get('adapterSHA256')==hashlib.sha256((root/'native/ProveKitJSONAdapter.c').read_bytes()).hexdigest(), 'Rebuild native runtime with the current ABI adapter.'
