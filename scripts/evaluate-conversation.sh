...
xcrun swiftc -parse-as-library -O -target "$(uname -m)-apple-macos26.0" \
  ...
  apps/ios/ZeroKeyMate/LocalConversationSession.swift apps/ios/ZeroKeyMate/PurchaseConversation.swift apps/ios/ZeroKeyMate/ConversationMemory.swift scripts/evaluate-conversation.swift \
