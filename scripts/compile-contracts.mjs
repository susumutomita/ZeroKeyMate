...
const inputFiles = ['contracts/src/MateVault.sol','contracts/src/MateResolverFactory.sol','contracts/src/MateAgeGate.sol','contracts/src/MatePurchaseAccount.sol','contracts/src/MateSharedBudget.sol','contracts/src/MateCatalogBudget.sol'];
if (process.argv.includes('--tests')) inputFiles.push('contracts/test/TestToken.sol','contracts/test/TestAuthorizationToken.sol','contracts/test/SharedBudgetTestToken.sol');
