...
const inputFiles = ['contracts/src/MateVault.sol','contracts/src/MateResolverFactory.sol','contracts/src/MateAgeGate.sol','contracts/src/MatePurchaseAccount.sol','contracts/src/MateSharedBudget.sol'];
